    ...
    <div class="col-lg-12 col-md-12 col-12">
      <div>
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <a href="#" class="btn btn-white" data-bs-toggle="modal" data-bs-target="#exampleModal-2">Add Auction</a>
          </div>
        </div>
      </div>
    </div>
                  ...
                  <tr>
                    <td class="align-middle">
                      <div class="d-flex align-items-center">
                        <div class="ms-0 lh-1">
                          <h5 class="mb-1">
                            <a href="./product/<?= $row['id_barang'] ?>" class="text-inherit"><?= $row['nama_barang']; ?></a>
                          </h5>
                        </div>
                      </div>
                    </td>
...
<div class="modal fade" id="exampleModal-2" tabindex="-1" role="dialog" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
