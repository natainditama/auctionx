                    ...
                    <div class="row position-relative">
                      <div class="col-auto pe-0 d-flex align-items-center">
                        <div class="avatar avatar-md">
                          <a href="#"><img src="https://i.pravatar.cc/150?img=<?= rand(1, 70); ?>" alt="Image" class="rounded-circle"></a>
                        </div>
                      </div>
                      <div class="col-auto">
                        <h4 class="mb-1 h5">
                    ...
                    <?php else :  ?>
                      <form method="POST" action="./auction/<?= $model['auction']['id_barang']; ?>">
                        ...
                        <div class="d-flex">
                          ...
                          <input class="form-control rupiah" name="price" type="number" min="<?= $model["auction"]["harga_awal"]; ?>" placeholder="Enter price quotation" required />
