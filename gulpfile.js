...
// Paths to project folders
 ...
 const paths = {
  ...
  src:{
    basesrc: './src/UI/',
    basesrcfiles: './src/UI/**/*',
    scss: './src/UI/assets/scss/**/*.scss',
    css: './src/UI/assets/css',
    js: './src/UI/assets/js/**/*.js',
    html: './src/UI/**/*.html',
    images: './src/UI/assets/images/**/*',
    fonts: './src/UI/assets/fonts/**/*',
...
function html(callback) {
  return src([paths.src.html, '!./src/UI/partials/**/*'])
      .pipe(fileinclude({
        prefix: '@@',
        basepath: '@file'
      }))
...
function cleanDist(callback) {
     del.sync([paths.dist.assets, paths.dist.docs, paths.dist.pages]);
     callback();
}
